...
The dropdown has six tabs — **Cost**, **Latency**, **Aggregates**, **Projections**, **Alerts**, and **Budget** — switched by the icon bar under the title. See the [screenshots and per-tab walkthrough](#what-it-shows) near the top of this README.
